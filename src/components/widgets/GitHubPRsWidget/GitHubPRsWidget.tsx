...
export function GitHubPRsWidget() {
  const [settings, setSettings] = useState<GitHubPRsWidgetSettings>(DEFAULT_SETTINGS);
  const [showSettings, setShowSettings] = useState(false);
  const { pullRequests, isLoading, error, lastUpdated, refresh } = useGitHubPRs(settings);
