...
import { ExternalLink, GitPullRequest, CheckCircle2, XCircle, Clock, GitMerge } from 'lucide-react';
...
export function PullRequestItem({ pullRequest }: PullRequestItemProps) {
  const { title, number, state, status, repository, user, html_url, updated_at, draft, comments, review_comments, requested_reviewers } = pullRequest;
