...
describe('Integration: Theme and Language Switching', () => {
  ...
  it('should persist theme and language preferences together', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /activer le thème sombre/i }));
  ...
  it('should allow multiple theme and language changes', async () => {
    ...
    const themeButton = screen.getByRole('button', { name: /activer le thème sombre/i });
    await user.click(themeButton);
    await user.click(screen.getByRole('button', { name: /activer le thème clair/i }));
